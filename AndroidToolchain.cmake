...
#
#    FORCE_ARM=0 - set 1 to generate 32-bit ARM instructions instead of Thumb-1.
#
#    NO_UNDEFINED=1 - set 1 to show all undefined symbols will as linker errors even if they are not used.
#
#
...
#
#     ANDROID and BUILD_ANDROID will be set to 1, you may test these
#     variables to make necessary changes.
#
#     Also ARMEABI and ARMEABI_V7A will be set 1, mutually exclusive. V7A is
#     for floating point. NEON option will be set 1 if fpu is set to neon.
#
...
if (NOT EXISTS "${ANDROID_NDK}")
    message(WARNING "ANDROID_NDK not exists: " ${ANDROID_NDK})
endif()
...
set(PossibleAndroidLevels "3;4;5;8;9;19")
...
# c ompatibility junk for previous version of toolchain
